...
namespace Ekko_master_of_time
{
    class Core
    {
        ...
        private void OnLoad(EventArgs args)
        {
            ...
            Game.PrintChat("<b><font color =\"#FF33D6\">"+tittle+ "</font></b> Loaded have fun :)!");
        ...
        private void Ondraw(EventArgs args)
        {
            ...
            Utility.HpBarDamageIndicator.DamageToUnit += hero => (float)riskCheck.GetDamageInput(new List<Spell> {Spells.Q,Spells.E,Spells.R},hero );
