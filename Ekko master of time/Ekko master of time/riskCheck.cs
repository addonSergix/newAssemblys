...
namespace Ekko_master_of_time
{
    static class riskCheck
    {
      ...
      /*  public static bool Unkilleable(List<Spell> spells, Obj_AI_Hero target)
        {
        ...
        */
        public static double GetDamageInput(List<Spell> spells, Obj_AI_Hero target)
        {
            double damage = 0;
            foreach (Spell s in spells)
            {
        ...
        public static double GetTowerDamage(Obj_AI_Hero target)
        {
